...
BAND2_FILE="./sample/himawari/fulldisk/band2/HS_H08_20170623_0250_B02_FLDK_R10_S0110.DAT.bz2"
BAND3_FILE="./sample/himawari/fulldisk/band3/HS_H08_20170623_0250_B03_FLDK_R05_S0110.DAT.bz2"
...
python3 main.py rgbfile red "$BAND3_FILE" green "$BAND2_FILE" blue "$BAND1_FILE" outpic himawari_full_rgb.png outdir "$OUTPUT_DIR" enhance

# 終了時刻を記録して処理時間を計算
END_TIME=$(date +%s)
ELAPSED_TIME=$((END_TIME - START_TIME))
echo ""
echo "RGB合成の処理時間: ${ELAPSED_TIME}秒"
echo ""
